...
# Lab 04 - Q2
# Roll for the Monsters Power
input("Roll for the Monster Magic Power (Press Enter)")
power_roll = random.choice(["Fire Magic", "Freezing Time", "Super Hearing"])
# Lab 04 - Q3
# Increase  the Monster Combat Strength
m_combat_strength = min(6, (m_combat_strength + monster_power[power_roll]))
print("The Monster Combat Strength is no" + str(combat_strength)+ "Using the" + power_roll +"")
